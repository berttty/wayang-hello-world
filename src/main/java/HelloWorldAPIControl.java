...
/**
 * Example Apache Wayang (incubating) App that does the Hello World of
 * Map/Reduce-like systems.
 */
public class HelloWorldAPIControl {
  /**
  ...
  public static void main(String[] args) throws IOException, URISyntaxException {
    try {
      ...
      wayangContext.execute(
          wayangPlan,
          ReflectionUtils.getDeclaringJar(HelloWorldAPIControl.class),
